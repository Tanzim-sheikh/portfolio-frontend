...
//           <div className="absolute hidden md:block left-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-amber-300 via-amber-200 to-transparent -translate-x-1/2 opacity-60"></div>
...
//             >
//               {/* Left side card (visible on desktop) */}
//               {item.side === "left" && (
//                 <div className="md:text-right md:pr-12">
//                   <motion.div
//                     variants={itemVariants}
//                     whileHover={{ scale: 1.02, y: -5 }}
//                     className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 border-l-4 md:border-l-0 md:border-r-4 border-amber-300 group"
//                   >
//                     <div className="flex md:flex-row-reverse items-center gap-4 mb-4">
//                       <div className="w-12 h-12 rounded-lg bg-amber-100 flex items-center justify-center text-amber-500 group-hover:scale-110 transition-transform duration-300">
//                         {item.icon}
//                       </div>
//                       <span className="text-sm font-mono bg-amber-100 text-amber-600 px-3 py-1 rounded-md font-semibold">
//                         {item.duration}
//                       </span>
//                     </div>
...
//                 </div>
//               )}
//               {/* Empty column for alignment when left card */}
...
//                       variants={itemVariants}
//                       whileHover={{ scale: 1.02, y: -5 }}
//                       className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 border-l-4 border-amber-300 group"
//                     >
...
//               {/* Central Dot - positioned exactly on the timeline */}
//               <div className="hidden md:block absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
//                 <div className="w-4 h-4 rounded-full bg-amber-300 shadow-[0_0_12px_rgba(251,191,36,0.7)] border-[3px] border-white"></div>
//               </div>
//             </div>
//           ))}
//         </motion.div>

//         {/* Additional Learning Journey Block - inspired by your second design */}
//         <motion.div
//           initial={{ opacity: 0, y: 30 }}
//           whileInView={{ opacity: 1, y: 0 }}
//           transition={{ duration: 0.6, delay: 0.4 }}
  ...
  return (
    <section id="education" className="w-full py-20 bg-gray-50 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            Academic <span className="text-amber-400">Blueprint</span>
          </h2>
          <div className="w-24 h-1 bg-amber-400 mx-auto mb-6 rounded-full shadow-[0_0_6px_#fbbf24]"></div>
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            My academic journey and professional growth in the tech industry
          </p>
        </motion.div>
        ...
        >
          ...
          {timelineData.map((item, idx) => (
            ...
            >
              ...
              {item.side === "left" && (
                <div className="md:text-right md:pr-12">
                  ...
                  >
                    ...
                    <div className="flex md:flex-row-reverse items-center gap-4 mb-4">
                      <div className="w-12 h-12 rounded-lg bg-amber-100 flex items-center justify-center text-amber-500 group-hover:scale-110 transition-transform duration-300 shadow-sm group-hover:shadow-amber-200/50">
                        {item.icon}
                      </div>
                    ...
                    <div className="w-full bg-gray-100 rounded-full h-2 overflow-hidden">
                      <motion.div
                        ...
                        className="h-full bg-gradient-to-r from-amber-400 to-amber-500 rounded-full shadow-[0_0_4px_#fbbf24]"
                      />
                    </div>
              ...
              <div className="hidden md:block absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
                <div className="w-4 h-4 rounded-full bg-amber-400 shadow-[0_0_12px_#fbbf24] border-[3px] border-white animate-pulse"></div>
              </div>
            </div>
          ))}
        </motion.div>
