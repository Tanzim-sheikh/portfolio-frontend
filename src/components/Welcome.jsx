...
export default function Welcome() {
  ...
  return (
    <main 
      id="welcome" 
      className="w-full min-h-screen flex items-center justify-center bg-white px-6 relative overflow-hidden pt-20 lg:pt-4" // FIXED: changed lg:pt-0 to lg:pt-28
    >
      {/* Background Elements */}
      ...
      <div className="max-w-6xl mx-auto w-full relative z-10 py-8 lg:py-0">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center px-4 sm:px-6 lg:px-0">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-amber-100 text-amber-800 px-4 py-2 rounded-full text-sm font-medium mb-8 mt-4 lg:mt-0"
            >
            ...
            >
              {[
                { icon: FiGithub, href: "https://github.com/Tanzim-sheikh", color: "hover:text-gray-900" },
                { icon: FiLinkedin, href: "https://www.linkedin.com/in/tanzim-sheikh-a42159328?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app", color: "hover:text-blue-600" }
              ].map((social, index) => (
                <motion.a
                  key={index}
                  href={social.href}
          ...
          >
            {/* Main Card */}
            <div className="relative bg-gradient-to-br from-amber-50 to-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-2xl border border-amber-100 mx-auto max-w-md lg:max-w-none">
              
              {/* Floating Elements */}
              <motion.div
                animate={{ y: [0, -20, 0] }}
                transition={{ duration: 4, repeat: Infinity }}
                className="absolute -top-3 -left-3 sm:-top-4 sm:-left-4 w-16 h-16 sm:w-20 sm:h-20 bg-blue-400 rounded-2xl flex items-center justify-center shadow-lg"
              >
